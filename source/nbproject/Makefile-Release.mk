...
OBJECTFILES= \
	...
	${OBJECTDIR}/ReferenceAbsenteException.o \
	${OBJECTDIR}/ReferenceDejaPresenteException.o \
...
${OBJECTDIR}/ReferenceAbsenteException.o: ReferenceAbsenteException.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ReferenceAbsenteException.o ReferenceAbsenteException.cpp

${OBJECTDIR}/ReferenceDejaPresenteException.o: ReferenceDejaPresenteException.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ReferenceDejaPresenteException.o ReferenceDejaPresenteException.cpp
...
${OBJECTDIR}/ReferenceAbsenteException_nomain.o: ${OBJECTDIR}/ReferenceAbsenteException.o ReferenceAbsenteException.cpp 
	${MKDIR} -p ${OBJECTDIR}
	@NMOUTPUT=`${NM} ${OBJECTDIR}/ReferenceAbsenteException.o`; \
	if (echo "$$NMOUTPUT" | ${GREP} '|main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T _main$$'); \
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ReferenceAbsenteException_nomain.o ReferenceAbsenteException.cpp;\
	else  \
	    ${CP} ${OBJECTDIR}/ReferenceAbsenteException.o ${OBJECTDIR}/ReferenceAbsenteException_nomain.o;\
	fi

${OBJECTDIR}/ReferenceDejaPresenteException_nomain.o: ${OBJECTDIR}/ReferenceDejaPresenteException.o ReferenceDejaPresenteException.cpp 
	${MKDIR} -p ${OBJECTDIR}
	@NMOUTPUT=`${NM} ${OBJECTDIR}/ReferenceDejaPresenteException.o`; \
	if (echo "$$NMOUTPUT" | ${GREP} '|main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T _main$$'); \
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ReferenceDejaPresenteException_nomain.o ReferenceDejaPresenteException.cpp;\
	else  \
	    ${CP} ${OBJECTDIR}/ReferenceDejaPresenteException.o ${OBJECTDIR}/ReferenceDejaPresenteException_nomain.o;\
	fi
